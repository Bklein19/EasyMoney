...
import { marcusConnector } from './institutions/marcusConnector.ts';
import { robinhoodBankingConnector } from './institutions/robinhoodBankingConnector.ts';
