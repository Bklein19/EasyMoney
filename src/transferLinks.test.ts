...
test("investment cash transfers carry source basis and gains into an existing destination account", () => {
  const flows = new Map([
  ...
  const result = deriveTransferLinks({
    accounts: [{ id: 1, type: "brokerage" }, { id: 2, type: "brokerage" }],
...
test("checking transfers do not carry market gains", () => {
  const flows = new Map([
    ["2026-03|1", { contributions: 0, dividends: 0, interest: 0 }],
    ["2026-04|1", { contributions: -10_000_00, dividends: 0, interest: 0 }],
    ["2026-04|2", { contributions: 10_000_00, dividends: 0, interest: 0 }],
  ...
  const balances = new Map([["2026-03|1", 12_500_00]]);
  const result = deriveTransferLinks({
    accounts: [{ id: 1, type: "checking" }, { id: 2, type: "brokerage" }],
    sortedMonths: ["2026-03", "2026-04"],
    flows,
    balances,
    seeds: new Map([
...
test("investment transfers into checking do not create checking gains", () => {
  const flows = new Map([
    ["2026-03|1", { contributions: 0, dividends: 0, interest: 0 }],
    ["2026-04|1", { contributions: -10_000_00, dividends: 0, interest: 0 }],
    ["2026-04|2", { contributions: 10_000_00, dividends: 0, interest: 0 }],
  ...
  const balances = new Map([["2026-03|1", 12_500_00]]);
  const result = deriveTransferLinks({
    accounts: [{ id: 1, type: "brokerage" }, { id: 2, type: "checking" }],
    sortedMonths: ["2026-03", "2026-04"],
    flows,
    balances,
    seeds: new Map([
